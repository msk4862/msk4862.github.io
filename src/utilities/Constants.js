...
export const Eductaion = [
  {
    title: "MCA",
    time: "2019-2022",
    name: "Department of Computer Science, Delhi University",
  },
  {
    title: "B.Sc.(H) Computer Science",
    time: "2016-2019",
...
export const Experience = {
  ...
  game_dev:
    "Designed and developed cross-platform mobile games with Unity3D and Android Studio.",
};
