...
const Loader = ({loading}) => {
    ...
    <svg version="1.1" id="loader" x="0px" y="0px"
        ...
        <g>
            ...
            <polygon className="stand-back" fill="#B0B6BB" points="317.793,459.034 194.207,459.034 211.862,388.414 300.138,388.414 	"/>
            <path className="monitor" fill="#38454F" d="M512,317.793H0V48.552c0-17.064,13.833-30.897,30.897-30.897h450.207
            c17.064,0,30.897,13.833,30.897,30.897V317.793z"/>
            <path fill="#E8EDEE" className="lower-border" d="M481.103,388.414H30.897C13.833,388.414,0,374.581,0,357.517v-39.724h512v39.724
            ...
            <polygon className="yellowbox" fill="#ECBA16" points="79.448,176.552 203.034,176.552 203.034,52.966 79.448,52.966 	"/>
        </g>
    </svg>
