  ...
  return (
    <div className="about col-12 col-lg-8">
      ...
      <p>
        ...
        from Delhi, India 🇮🇳, currently, I am a computer science postgrad
        student who loves programming and interested in solving real world
        problems using the technologies present out there. Beside's programming,
        I enjoy UI designing <i className="fas fa-paint-brush"></i>, photography{" "}
          ...
          {Eductaion.map(edu => {
            return (
              <div key={edu.title} className="row">
                ...
                <div className="col-10 education">
                  <p className="mb-0">
                    <span>{edu.title}</span>
                    <span>, {edu.time}</span>
                  </p>
                  <small className="ed-meta">{edu.name}</small>
                </div>
              </div>
            );
          })}
